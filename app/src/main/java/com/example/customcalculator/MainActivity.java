...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialButton buttonDivide,buttonMultiplication,buttonAdd,buttonSutract,buttonEquals;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(buttonSutract,R.id.button_subtract);
        ...
        assignId(buttonEquals,R.id.button_equalls);
